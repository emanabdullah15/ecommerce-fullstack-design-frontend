...
const AdminPanel = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ name: "", category: "consumer-electronics", price: 0, discount: 0, description: "", img: null });
      setEditingId(null);
      fetchProducts();
    } catch (err) {
      console.error(err);
  ...
  const handleEdit = (product) => {
    setFormData({ name: product.name, category: product.category, price: product.price, discount: product.discount || 0, description: product.description, img: null });
